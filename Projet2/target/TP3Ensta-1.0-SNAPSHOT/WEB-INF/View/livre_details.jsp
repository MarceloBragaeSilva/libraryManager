  ...
  <main>
    <section class="content">
      ...
      <h5>Details du livre n${livre.key}</h5>
        <div class="row">
	      <form action="livre_details?id=${livre.key}" method="post" class="col s12"> <!-- TODO : remplacer idDuLivre par l'id du livre -->
	        <div class="row">
	      ...
	      <form action="livre_delete" method="get" class="col s12">
	        <input type="hidden" value="${livre.key}" name="id"> <!-- TODO : remplacer idDuLivre par l'id du livre -->
	        <div class="row center">
