      ...
      <div class="row">
        <div class="col l4 s6">
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3>${count_membre}</h3> <!--  : afficher le nombre de membres � la place de 12 -->
              <p>Membres</p>
            </div>
            <div class="icon">
        ...
        <div class="col l4 s6">
          <div class="small-box bg-green">
            <div class="inner">
              <h3>${count_livre}</h3> <!--  : afficher le nombre de livres � la place de 27 -->
              <p>Livres</p>
            </div>
            <div class="icon">
        ...
        <div class="col l4 s6">
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3>${count_emprunt}</h3> <!--  : afficher le nombre d'emprunts � la place de 1515 -->
              <p>Emprunts</p>
            </div>
            <div class="icon">
                ...
                <tbody id="results">
                  <c:if test="${!list_currentEmprunt.isEmpty()}">
                    <c:forEach items="${list_currentEmprunt}" var="emprunt">
                     ...
                     <!-- : parcourir la liste des emprunts en cours et les afficher selon la structure d'exemple ci-dessus -->
                </tbody>
            </table>
          </div>
        </div>
